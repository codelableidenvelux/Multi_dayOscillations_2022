...
load('../JIDCycles/ForCluster.mat', 'Period')
...
parfor IDX = 1:n_subs
    ...
    % slice to get `short` range
    masked_a = reshape(squeeze(active_tensor(IDX, :, :, :)), n_scales, 2500);
...
%% save result
save('subject_level_nmf_short_preferred_ranks_sorted_v2', 'all_H', 'all_W', 'preferred_rank')       
