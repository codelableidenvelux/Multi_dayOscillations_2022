...
%                  
% 
% Enea Ceolini, Leiden University, 21/10/2021
...
fb = cwtfilterbank( 'SignalLength',(size(px_z,2)),'SamplingPeriod',hours(1), 'VoicesPerOctave',40,  'PeriodLimits', [hours(2) hours(80*24)]);
...
cw_x(i,:) = sqrt(nanmean(abs(cw_nan),2)); 
% signficance test
